    ...
    internal class ShopTools : IShop, IStoreListener
    {
        ...
        public ShopTools(List<ShopProduct> products)
        {
            ...
            ConfigurationBuilder builder =
                ConfigurationBuilder.Instance(StandartPurchasingModule.Instance());
        ...
        public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs purchaseEvent)
        {
            ...
            CrossPlatformValidator validator = new CrossPlatformValidator(GooglePlayTangle.Data(),
                AppTangle.Data(), Application.identifier);
            try
            {
...
_extensionProvider.GetExtension<IAppleExtension>().RestoreTransactions(OnRestoreTransactionFinished);
#else

_extensionProvider.GetExtention<IGooglePlayStoreExtentions>().RestoreTransactions(OnRestoreFinished);
#endif
